...
fn main() {
    ...
    for (module_name, xml_file) in &fixtures {
        ...
        // Generate Rust code using rusterix-codegen
...
/// Generate Rust code from XML content using rusterix-codegen.
fn generate_code(xml_content: &str) -> Result<String, String> {
    ...
    // This requires adding rusterix-codegen as a build dependency
