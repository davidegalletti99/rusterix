...
```rust
use rusterix_core::{Decode, Encode, BitReader, BitWriter, DecodeError};
...
This crate is typically used indirectly through generated code. The main `rusterix` crate re-exports it as the `rcore` module:
