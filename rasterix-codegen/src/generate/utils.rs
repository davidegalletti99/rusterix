...
///
/// ```
/// use rasterix_codegen::generate::utils::rust_type_for_bits;
...
/// ```
/// use quote::format_ident;
/// use rasterix_codegen::generate::utils::to_pascal_case;
...
/// ```
/// use quote::format_ident;
/// use rasterix_codegen::generate::utils::to_snake_case;
